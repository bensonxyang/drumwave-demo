...
The front end is responsible for form validation and submitting data, while the server handles create/update logic.
In a production setup, the front-end application, API, and database would usually be hosted as separate services.
For simplicity and demonstration purposes, everything in this example is kept within a single project and data is 
stored in memory.
